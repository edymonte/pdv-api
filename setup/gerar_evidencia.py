...
PILARES = [
    ...
    },
    {
        ...
        "descricao": "Wiki de documentação consultada pelo agente para implementar regras de negócio reais",
        "icone": "📚",
        "checks": [
            {
                "desc": "Wiki de regras de negócio presente (docs/wiki/regras-de-negocio.md)",
                "tipo": "arquivo_existe",
                "arquivo": "docs/wiki/regras-de-negocio.md",
            },
            {
                "desc": "Wiki contém regras de desconto consultáveis pelo agente",
                "tipo": "presenca_texto",
                "arquivo": "docs/wiki/regras-de-negocio.md",
                "pattern": r"Desconto|desconto",
            },
            {
                "desc": "Wiki regulatório ANVISA presente (docs/wiki/regulatorio-anvisa.md)",
                "tipo": "arquivo_existe",
                "arquivo": "docs/wiki/regulatorio-anvisa.md",
            },
            {
